...
- **옵션**: Ollama (AI), Redis + PostgreSQL 18 (DB), KakaoTalk (Mac App Store)
...
- `INSTALL_KAKAOTALK=1` 을 켠 경우에 한해 App Store 로그인 필요.
...
| `INSTALL_KAKAOTALK` | `0` | Mac App Store에서 KakaoTalk 설치 (`1`로 설정 시 App Store 로그인 필요) |
